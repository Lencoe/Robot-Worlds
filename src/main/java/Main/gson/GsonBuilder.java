...
import Main.gson.annotations.Expose;
import Main.gson.annotations.Since;
import Main.gson.annotations.Until;
import Main.gson.internal.$Gson$Preconditions;
import Main.gson.internal.Excluder;
import Main.gson.internal.bind.DefaultDateTypeAdapter;
import Main.gson.internal.bind.TreeTypeAdapter;
import Main.gson.internal.bind.TypeAdapters;
import Main.gson.internal.sql.SqlTypesSupport;
  ...
  private void addTypeAdaptersForDate(String datePattern, int dateStyle, int timeStyle,
    ...
    if (datePattern != null && !datePattern.trim().isEmpty()) {
      ...
      if (sqlTypesSupported) {
        sqlTimestampAdapterFactory = (TypeAdapterFactory) SqlTypesSupport.TIMESTAMP_DATE_TYPE.createAdapterFactory(datePattern);
        sqlDateAdapterFactory = (TypeAdapterFactory) SqlTypesSupport.DATE_DATE_TYPE.createAdapterFactory(datePattern);
      }
    } else if (dateStyle != DateFormat.DEFAULT && timeStyle != DateFormat.DEFAULT) {
      dateAdapterFactory = DefaultDateTypeAdapter.DateType.DATE.createAdapterFactory(dateStyle, timeStyle);

      if (sqlTypesSupported) {
        sqlTimestampAdapterFactory = (TypeAdapterFactory) SqlTypesSupport.TIMESTAMP_DATE_TYPE.createAdapterFactory(dateStyle, timeStyle);
        sqlDateAdapterFactory = (TypeAdapterFactory) SqlTypesSupport.DATE_DATE_TYPE.createAdapterFactory(dateStyle, timeStyle);
      }
    } else {
      return;
    }
